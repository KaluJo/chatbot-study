...
export function DemoFooter() {
  ...
  return (
    <footer className="border-t border-gray-200 bg-white mt-auto">
      <div className="max-w-4xl mx-auto px-4 py-4 flex flex-col items-center gap-2 text-center">
        <div className="flex flex-wrap justify-center items-center gap-x-3 gap-y-1 text-xs text-gray-400">
          <span>© {new Date().getFullYear()}{' '}
            <a href="https://www.bhadayun.com/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-700 transition-colors">
              Bhada Yun
            </a>
          </span>
          <span className="hidden sm:inline">·</span>
          <a href="https://github.com/KaluJo/chatbot-study" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 hover:text-gray-700 transition-colors">
